...
/**
 * InProgressComplaints component displays complaints with "In Progress" status for admin users
 ...
 */
const InProgressComplaints = ({ isLoading: initialLoading, refetch: refetchAll, role }) => {
  ...
  // Fetch complaints with "In Progress" status
  const {
    data: responseData,
    isLoading,
    refetch
