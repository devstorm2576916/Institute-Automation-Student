...
/**
 * ResolvedComplaints component displays complaints with "Resolved" status for admin users
 ...
 */
const ResolvedComplaints = ({ isLoading: initialLoading, refetch: refetchAll, role }) => {
  ...
  // Fetch complaints with "Resolved" status
  const {
    data: responseData,
    isLoading,
    refetch
